...
import { ITable, ITableItem, ITableColumn } from "./Table.types";
		...
		() =>
			columns
				.map((column: ITableColumn) => {
					...
					const tblHeaderTitle =
						tableColumnsMapping[column.key] &&
						tableColumnsMapping[column.key].title
							? tableColumnsMapping[column.key].title
							: column.name;
					return (
						<th key={tblHeaderKey}>
